...
def test(image_name, model_dir, device_id):
    ...
    cv2.rectangle(
        image, (image_bbox[0], image_bbox[1]), (image_bbox[0] + image_bbox[2], image_bbox[1] + image_bbox[3]), color, 2
    )
    cv2.putText(
        image,
        result_text,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--device_id", type=str, default="0", help="which gpu id, [0/1/2/3]. if use cpu, set 'cpu'")
